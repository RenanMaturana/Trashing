<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Operador.aspx.cs" Inherits="BasureroWeb.Vistas.Operador" %>
                    ...
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level collapse">
                                <li><a href="OPERADOR/BasureroOperador.aspx"><i class="fa fa-trash"></i><span class="nav-label">Agregar basurero</span></a></li>
                                <li><a href="OPERADOR/Lista_basOperador.aspx"><i class="fa fa-list-alt"></i><span class="nav-label">Listado basureros</span></a></li>
                                <li><a href="OPERADOR/ModBasureroOperador.aspx"><i class="fa fa-edit"></i><span class="nav-label">Modificar basurero</span></a></li>
                                <li><a href="OPERADOR/UbicacionOperador.aspx"><i class="fa fa-location-arrow"></i><span class="nav-label">Agregar Ubicacion</span></a></li>
                                <li><a href="OPERADOR/BodegaOperador.aspx"><i class="fa fa-archive"></i><span class="nav-label">Agregar Bodega</span></a></li>
                                <li><a href="OPERADOR/EstadoBasureroOperador.aspx"><i class="fa fa-empire"></i><span class="nav-label">Agregar Estado</span></a></li>
                            </ul>
                        </li>
                        <li class="special_link">
                            <a href="OPERADOR/InformesOperador.aspx"><i class="fa fa-file-pdf-o"></i><span class="nav-label">Modulo informes</span></a>
                        </li>
                    </ul>
