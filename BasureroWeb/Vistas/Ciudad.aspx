<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ciudad.aspx.cs" Inherits="BasureroWeb.Vistas.Ciudad" %>
            ...
            <div id="page-wrapper" class="gray-bg sidebar-content" style="min-height: 661px; background-color: lightgray">
                ...
                <div class="wrapper wrapper-content">
                    ...
                    <div class="container panel panel-success col-md-8" style="padding: 5px; background-color: white">
                        <h3 class="text-center">Ingrese Ciudad</h3>
                        <br />
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <asp:TextBox ID="txt_idCargo" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                                <br />
                                <label for="txt_nameCargo">Nombre Ciudad</label>
                                <asp:TextBox ID="txt_nameCiudad" CssClass="form-control" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="validarCiudad" runat="server"
                                    SetFocusOnError="true"
                                    ErrorMessage="el campo es obligatorio"
                                    Display="Dynamic"
                                    ForeColor="Red"
                                    ValidationGroup="grupo1"
                                    ControlToValidate="txt_nameCiudad">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btn_registrarCiudad" CssClass="form-control btn btn-primary" runat="server" Text="Agregar" OnClick="btn_registrarCiudad_Click" />
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="container panel panel-success col-md-12" style="padding: 5px; background-color: white">
                        <asp:GridView ID="list_Cargos" runat="server"
                            CssClass="table table-bordered panel panel-primary text-center"
                            AutoGenerateColumns="false"
                            OnRowCommand="list_Cargos_RowCommand"
                            OnPageIndexChanging="list_Cargos_PageIndexChanging"
                            AllowPaging="true"
                            PageSize="10">
