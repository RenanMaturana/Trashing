<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estado.aspx.cs" Inherits="BasureroWeb.Vistas.Estado" %>
                ...
                <div class="wrapper wrapper-content">
                    ...
                    <div class="container panel panel-success col-md-8" style="padding: 5px; background-color: white">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btn_registrarEstado" CssClass="form-control btn btn-primary" runat="server" Text="Agregar" OnClick="btn_registrarEstado_Click" />
                            </div>
                            <div class="col-md-4">
