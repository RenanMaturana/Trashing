<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cargo.aspx.cs" Inherits="BasureroWeb.Vistas.Cargo" %>
            ...
            <div id="page-wrapper" class="gray-bg sidebar-content" style="min-height: 661px; background-color: lightgray">
                ...
                <div class="wrapper wrapper-content">
                    ...
                    <div class="container panel panel-success col-md-8" style="padding: 5px; background-color: white">
                        <h3 class="text-center">Ingrese Cargo</h3>
                        <br />
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <asp:TextBox ID="txt_idEstado" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                                <br />
                                <label for="txt_nameCargo">Nombre Cargo</label>
                                <asp:TextBox ID="txt_nameCargo" CssClass="form-control" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator
                                    ...
                                    ForeColor="Red"
                                    ValidationGroup="g1"
                                    ControlToValidate="txt_nameCargo">
                                </asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btn_registrarCargo" CssClass="form-control btn btn-primary" runat="server" Text="Agregar" OnClick="btn_registrarCargo_Click" />
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="container panel panel-success col-md-12" style="padding: 5px; background-color: white">
                        <asp:GridView ID="list_cargo" runat="server"
                            CssClass="table table-bordered panel panel-primary text-center"
                            AutoGenerateColumns="false"
                            OnRowCommand="list_cargo_RowCommand"
                            OnPageIndexChanging="list_cargo_PageIndexChanging"
                            AllowPaging="true"
                            PageSize="10">
