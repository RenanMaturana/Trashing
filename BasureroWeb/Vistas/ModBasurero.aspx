<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModBasurero.aspx.cs" Inherits="BasureroWeb.Vistas.ModBasurero" %>
...
<body class="fixed-navigation  pace-done">
    <form runat="server" method="post" id="form1" autocomplete="off">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg sidebar-content" style="min-height: 800px;">
                ...
                <div class="wrapper wrapper-content">
                    ...
                    <div class="container panel panel-primary col-md-8" style="padding: 5px; background-color: whitesmoke">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <asp:TextBox ID="txt_id" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="txt_identificador">Identificador</label>
                                <asp:TextBox ID="txt_identificador" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="txt_fecha">Fecha Entrada</label>
                                <asp:TextBox ID="txt_fecha" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-10">
                                <label for="txt_fecha2">Fecha Salida</label>
                                <asp:TextBox ID="txt_fecha2" CssClass="form-control" runat="server"></asp:TextBox>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <asp:TextBox ID="txt_carga" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="select_bodega">Bodega</label>
                                <asp:DropDownList ID="select_bodega" CssClass="form-control" runat="server" DataSourceID="ef_bodegaa" DataTextField="nombreBodega" DataValueField="idBodega"></asp:DropDownList>
                                <asp:EntityDataSource runat="server" ID="ef_bodegaa" DefaultContainerName="basureroEntities" ConnectionString="name=basureroEntities" EnableFlattening="False" EntitySetName="bodega"></asp:EntityDataSource>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-6">
                                <asp:Button ID="btn_editar" CssClass="form-control btn btn-success" runat="server" Text="Editar" OnClick="btn_editar_Click" />
                            </div>
                            <div class="col-md-6">
                                <asp:Button ID="btn_eliminar" CssClass="form-control btn btn-danger" runat="server" Text="Eliminar" OnClick="btn_eliminar_Click" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="form-group">
                        <div class="container panel panel-success col-md-12" style="padding: 1px; background-color: white">
                            <asp:GridView ID="list_Basureros" runat="server"
                                CssClass="table table-bordered panel panel-primary text-center"
                                AutoGenerateColumns="false"
                                OnRowCommand="list_Basureros_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:ButtonField ButtonType="Link" ControlStyle-CssClass="nav-link  badge badge-success badge-info dropdown-toggle"
                                        CommandName="idSeleccionar" Text="Select" />
                                </Columns>
                            </asp:GridView>
