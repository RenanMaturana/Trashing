<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BodegaOperador.aspx.cs" Inherits="BasureroWeb.Vistas.OPERADOR.BodegaOperador" %>
            ...
            <div id="page-wrapper" class="gray-bg sidebar-content" style="min-height: 661px; background-color: lightgray">
                ...
                <div class="wrapper wrapper-content">
                    ...
                    <div class="container panel panel-success col-md-8" style="padding: 5px; background-color: white">
                        <h3 class="text-center">Ingrese datos Bodega</h3>
                        <br />
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <asp:TextBox ID="txt_idEstado" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                                <br />
                                <label for="txt_nameCargo">Nombre Bodega</label>
                                <asp:TextBox ID="txt_nameBodega" CssClass="form-control" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="validarBodega" runat="server"
                                    SetFocusOnError="true"
                                    ErrorMessage="el campo es obligatorio"
                                    Display="Dynamic"
                                    ForeColor="Red"
                                    ValidationGroup="grupo1"
                                    ControlToValidate="txt_nameBodega">
                    ...
                    <div class="container panel panel-success col-md-12" style="padding: 5px; background-color: white">
                        <asp:GridView ID="list_bod" runat="server"
                            CssClass="table table-bordered panel panel-primary text-center"
                            AutoGenerateColumns="false"
                            OnRowCommand="list_bod_RowCommand"
                            OnPageIndexChanging="list_bod_PageIndexChanging"
                            AllowPaging="true"
                            PageSize="10">
