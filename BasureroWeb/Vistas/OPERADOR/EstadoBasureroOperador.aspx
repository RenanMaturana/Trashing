<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadoBasureroOperador.aspx.cs" Inherits="BasureroWeb.Vistas.OPERADOR.EstadoBasureroOperador" %>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg sidebar-content" style="min-height: 661px; background-color: lightgray">
                ...
                <div class="wrapper wrapper-content">
                    ...
                    <div class="container panel panel-success col-md-8" style="padding: 5px; background-color: white">
                        <h3 class="text-center">Ingrese Estados Basurero</h3>
                        <br />
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <asp:TextBox ID="txt_idEstado" CssClass="form-control" ReadOnly="true" runat="server"></asp:TextBox>
                                <br />
                                <label for="txt_nameCargo">Nombre Estado</label>
                                <asp:TextBox ID="txt_nameEstado" CssClass="form-control" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="validarEstado" runat="server"
                                    SetFocusOnError="true"
                                    ErrorMessage="el campo es obligatorio"
                                    Display="Dynamic"
                                    ForeColor="Red"
                                    ValidationGroup="grupo1"
                                    ControlToValidate="txt_nameEstado">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:Button ID="btn_registrarBodega" CssClass="form-control btn btn-primary" runat="server" Text="Agregar" OnClick="btn_registrarBodega_Click" />
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="container panel panel-success col-md-12" style="padding: 5px; background-color: white">
                        <asp:GridView ID="list_estados" runat="server"
                            CssClass="table table-bordered panel panel-primary text-center"
                            AutoGenerateColumns="false"
                            OnRowCommand="list_estados_RowCommand"
                            OnPageIndexChanging="list_estados_PageIndexChanging"
                            AllowPaging="true"
                            PageSize="10">
