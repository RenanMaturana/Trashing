<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Informes.aspx.cs" Inherits="BasureroWeb.Vistas.AdminPDF.Informes" %>
            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                        ...
                        <li class="special_link">
                            <a href="#"><i class="fa fa-file-pdf-o"></i><span class="nav-label">Modulo informes</span></a>
                        </li>
                    </ul>
                                ...
                                <div class="row">
                                        ...
                                        <div class="ibox">
                                            <div class="ibox-content product-box" style="background-color: lightsteelblue">
                                                <div class="product-imitation">
                                                    <i class="fa fa-users fa-3x" style="color: black"></i>
                                                    <br />
                                                    <h2 style="color: black">Informe de usuarios</h2>
                                                </div>
                                                <div class="product-desc">
                                                    <small class="text-muted">PDF</small><br />
                                                    <asp:Button ID="btn_pdfusuario" OnClick="btn_pdfusuario_Click" runat="server" Text="Descargar" CssClass="btn btn-success" Style="text-align: center; display: block; margin-right: auto; width: 190px;" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="ibox">
                                            <div class="ibox-content product-box" style="background-color: lightsteelblue">
                                                ...
                                                <div class="product-imitation">
                                                    <i class="fa fa-building fa-3x" style="color: black"></i>
                                                    <br />
                                                    <h2 style="color: black">Informe de Ciudades</h2>
                                                </div>
                                                <div class="product-desc">
                                                    <small class="text-muted">PDF</small><br />
                                                    <asp:Button ID="btn_pdfciudad" OnClick="btn_pdfciudad_Click" runat="server" Text="Descargar" CssClass="btn btn-success" Style="text-align: center; display: block; margin-right: auto; width: 190px;" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="ibox">
                                            <div class="ibox-content product-box" style="background-color: lightsteelblue">
                                                <div class="product-imitation">
                                                    <i class="fa fa-archive fa-3x" style="color: black"></i>
                                                    <br />
                                                    <h2 style="color: black">Detalle Bodega</h2>
                                                </div>
                                                <div class="product-desc">
                                                    <small class="text-muted">PDF</small><br />
                                                    <asp:Button ID="btn_pdfBodega" OnClick="btn_pdfBodega_Click" runat="server" Text="Descargar" CssClass="btn btn-success" Style="text-align: center; display: block; margin-right: auto; width: 190px;" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
